...
// class AnalysisService {
//   constructor() {
//     // Gemini replaced by Ollama (same interface)
//     this.model = OllamaService;
//     this.redis = RedisService;
//   }
...
class AnalysisService {
  ...
  async analyzeSubject(input) {
    ...
    try {
      ...
      // 🔥 Universal AI call (Gemini / Ollama / DeepSeek)
      const { output, provider } = await this.ai.generate(prompt);
      const analysisResult = this.parseAIResponse(output);
